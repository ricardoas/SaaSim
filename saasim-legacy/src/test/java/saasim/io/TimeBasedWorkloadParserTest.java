...
public class TimeBasedWorkloadParserTest extends ValidConfigurationTest{
	...
	public void testConstructor(){
		new TimeBasedWorkloadParser(5000);
	}
	
	@Test(expected=RuntimeException.class)
	public void testConstructorWithoutParsers(){
		new TimeBasedWorkloadParser(5000, new String[]{});
	}
...
//		
//		TimeBasedWorkloadParser parser = new TimeBasedWorkloadParser(5000);
//		
//		parser.clear();
//		
...
//		GEISTWorkloadParser[] parsers = new GEISTWorkloadParser[]{parser1, parser2};
//		
//		TimeBasedWorkloadParser parser = new TimeBasedWorkloadParser(tick);
