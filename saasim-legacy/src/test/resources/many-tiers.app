...
saas.application.numberoftiers=5
...
saas.application.heuristic=ROUNDROBIN,ROUNDROBIN,ROUNDROBIN,ROUNDROBIN,ROUNDROBIN
#saas.application.heuristicclass=
saas.application.startreplicas=1,1,1,1,1
saas.application.maxreplicas=1,,,2,1
