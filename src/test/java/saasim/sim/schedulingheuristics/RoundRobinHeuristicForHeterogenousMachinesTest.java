...
//		Machine nextServer = this.heuristic.next(request);
//		assertNotNull(nextServer);
//		assertEquals(nextServer, machine);
//		
//		//Asking for another machine
//		nextServer = this.heuristic.next(request);
//		assertNotNull(nextServer);
//		assertEquals(nextServer, machine);
//		
//		nextServer = this.heuristic.next(request);
...
//		this.heuristic.finishServer(machine3, 2);
//		
//		//Starting all over again!
//		nextServer = this.heuristic.next(request);
//		assertNotNull(nextServer);
...
//		this.heuristic.finishServer(machine2, 2);
//		
//		//Since first machine power is one, now the second machine should be retrieved
//		nextServer = this.heuristic.next(request);
//		assertNotNull(nextServer);
...
//		this.heuristic.finishServer(machine, 0);
//		
//		//Starting all over again!
//		nextServer = this.heuristic.next(request);
//		assertNotNull(nextServer);
