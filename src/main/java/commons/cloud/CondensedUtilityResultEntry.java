...
public class CondensedUtilityResultEntry implements Comparable<CondensedUtilityResultEntry>, Serializable {
	...
	public CondensedUtilityResultEntry(long time, User[] users, Provider[] providers) {
		assert users != null;
	 ...
	 */
	@Override
	public int compareTo(CondensedUtilityResultEntry o) {
	...
	public boolean equals(Object obj) {
		...
		if (this == obj)
			return true;
		CondensedUtilityResultEntry other = (CondensedUtilityResultEntry) obj;
		if (time != other.time)
			return false;
		return true;
	}
