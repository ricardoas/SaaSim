...
@Singleton
public class MultiTenantASPWithResponseTimeLogging extends AbstractASP implements ASP {

	private Tenant[] tenants;
	
	@Inject
	public MultiTenantASPWithResponseTimeLogging(Configuration globalConf, ProvisioningSystem provisioningSystem, Provider<Tenant> tenantProvider) {
