...
import static saasim.core.config.IaaSProvidersProperties.IAAS_NUMBER_OF_PROVIDERS;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_COST_TRANSFER_IN;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_COST_TRANSFER_OUT;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_MONITORING;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_NAME;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_ONDEMAND_CPU_COST;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_ONDEMAND_LIMIT;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_ONE_YEAR_FEE;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_RESERVED_CPU_COST;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_RESERVED_LIMIT;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_THREE_YEARS_FEE;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_TRANSFER_IN;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_TRANSFER_OUT;
import static saasim.core.config.IaaSProvidersProperties.IAAS_PROVIDER_TYPES;
import static saasim.core.config.SaaSAppProperties.APPLICATION_CUSTOM_HEURISTIC;
import static saasim.core.config.SaaSAppProperties.APPLICATION_FACTORY;
import static saasim.core.config.SaaSAppProperties.APPLICATION_HEURISTIC;
import static saasim.core.config.SaaSAppProperties.APPLICATION_INITIAL_SERVER_PER_TIER;
import static saasim.core.config.SaaSAppProperties.APPLICATION_MAX_SERVER_PER_TIER;
import static saasim.core.config.SaaSAppProperties.APPLICATION_NUM_OF_TIERS;
import static saasim.core.config.SaaSAppProperties.APPLICATION_SETUP_TIME;
...
import saasim.core.cloud.SaaSContract;
...
//	 * @throws IOException
//	 */
//	private IaaSProvider[] readIaaSProviders() throws ConfigurationException{
...
//		
//		InstanceType[][] machinesType = getEnum2DArray(IAAS_PROVIDER_TYPES, InstanceType.class);
...
//		InstanceType[][] machines = getEnum2DArray(IAAS_PLAN_PROVIDER_TYPES, InstanceType.class);
...
//			}
//			
//			providers[i] = new IaaSProvider(i, names[i], onDemandLimits[i],
...
//	 * @throws IOException
//	 */
//	private SaaSClient[] readSaaSClients() throws ConfigurationException{
//		int numberOfPlans = getInt(NUMBER_OF_PLANS);
//		
//		SaaSContract[] contracts = readContracts();
//		
//		Map<String, SaaSContract> contractsPerName = new HashMap<String, SaaSContract>();
...
//		
//		SaaSClient[] users = new SaaSClient[numberOfUsers];
...
//			}
//			
//			users[i] = new SaaSClient(i, contractsPerName.get(plans[i]), storageInBytes[i]);
//		}
//		return users;
//	}
//
//	private SaaSContract[] readContracts() throws ConfigurationException {
//		
//		int numberOfPlans = getInt(NUMBER_OF_PLANS);
//		
//		SaaSContract[] contracts = new SaaSContract[numberOfPlans];
//		
...
//			}
//			SaaSContract plan = new RunTimeSLAContract(planNames[i], priorities[i], setupCosts[i], prices[i], 
...
//		Validator.checkIsEnum2DArray(IAAS_PROVIDER_TYPES, getStringArray(IAAS_PROVIDER_TYPES), InstanceType.class, ARRAY_SEPARATOR);
//	}
//	
//	
//	
...
//				throw new ConfigurationException("IaaSProvider " + provider + " need to be defined at providers configuration file.");
//			}
//		}
//		
//	}
...
//	}
//
//	public IaaSProvider[] getProviders() {
//		return this.providers;
//	}
//
//	public SaaSClient[] getUsers() {
//		return this.clients;
//	}
//
