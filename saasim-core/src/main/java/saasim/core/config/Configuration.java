...
import static saasim.core.config.IaaSPlanProperties.*;
import static saasim.core.config.IaaSProvidersProperties.*;
import static saasim.core.config.SaaSAppProperties.*;
import static saasim.core.config.IaaSProvidersProperties.*;
import static saasim.core.config.IaaSProvidersProperties.*;
import static saasim.core.config.IaaSProvidersProperties.*;
...
public class Configuration extends ComplexPropertiesConfiguration{
	 ...
	 * @throws IOException
	 */
	private Provider[] readIaaSProviders() throws ConfigurationException{
	 ...
	 * @throws IOException
	 */
	private User[] readSaaSClients() throws ConfigurationException{
